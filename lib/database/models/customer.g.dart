...
void _customerSerialize(
  ...
  writer.writeString(offsets[7], object.pic);
}
...
Customer _customerDeserialize(
  ...
  object.pic = reader.readStringOrNull(offsets[7]);
  return object;
}
...
extension CustomerQueryFilter
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'pic',
      ));
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'pic',
      ));
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pic',
        value: '',
  ...
  QueryBuilder<Customer, Customer, QAfterFilterCondition> picIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'pic',
        value: '',
...
extension CustomerQuerySortBy on QueryBuilder<Customer, Customer, QSortBy> {
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> sortByPic() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pic', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> sortByPicDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQuerySortThenBy
  ...
  QueryBuilder<Customer, Customer, QAfterSortBy> thenByPic() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pic', Sort.asc);
    });
  }

  QueryBuilder<Customer, Customer, QAfterSortBy> thenByPicDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pic', Sort.desc);
    });
  }
...
extension CustomerQueryWhereDistinct
  ...
  QueryBuilder<Customer, Customer, QDistinct> distinctByPic(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CustomerQueryProperty
  ...
  QueryBuilder<Customer, String?, QQueryOperations> picProperty() {
    return QueryBuilder.apply(this, (query) {
